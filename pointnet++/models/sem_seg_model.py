...
#The original pointnet++ is used without concern for the influence of point density
'''
Point_SA class(npoint:#points sampled in FPS, radius: search radius in local region, 
			nsample: how many points in each local region, mlp:output size for MLP on each point,...)
'''				   
