...
class CentroidTracker:
    ...
    def update(self, rects):
        ...
        for (i, (startY,endY, startX ,endX )) in enumerate(rects):
        ...
        if len(self.objects) == 0:
            for i in range(0, len(inputCentroids)):
                self.register(inputCentroids[i], rects[i])  # CHANGE
        ...
        # centroids
            ...
            for (row, col) in zip(rows, cols):
                ...
                self.bbox[objectID] = rects[col] # CHANGE
            ...
            if D.shape[0] >= D.shape[1] and len(unusedRows)>0:
        ...
        # return self.objects
        return (self.bbox,self.disappeared)
